...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex min-h-svh w-full items-center justify-center bg-white dark:bg-black",
        containerClassName
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-cyan-300 to-blue-400 px-1 pb-1 dark:from-cyan-500 dark:to-blue-600`,
        className
      )}
    >
      {children}
