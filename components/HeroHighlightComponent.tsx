      ...
      <div className="flex flex-col items-center justify-center min-h-[90vh] text-center px-4">
        ...
        >
          <button
            ...
            className="px-8 py-3 bg-black dark:bg-white text-white dark:text-black font-semibold rounded-full shadow-md transition duration-300 hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-blue-500/40 cursor-pointer"
          >
            View My Work
          </button>
          ...
          <button
            ...
            className="px-8 py-3 border-2 border-black dark:border-white text-black dark:text-white font-semibold rounded-full transition duration-300 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black focus:outline-none focus:ring-4 focus:ring-blue-500/40 cursor-pointer"
          >
            Get in Touch
          </button>
        </motion.div>
